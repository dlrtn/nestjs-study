...
import { MemberBuilder } from '../domain/member.builder';
...
export class MemberService {
  ...
  async register(requestDto: MemberRegisterRequestDto): Promise<Member> {
    const member = MemberBuilder.new()
      .withEmail(requestDto.email)
      .withPassword(requestDto.password)
      .withNickname(requestDto.nickname)
